...
#define MYTOKEN "VIDEO1234"
#define STORAGE "SERVER"
#define SERNAME "VIDEO_SERVER"
#define SERTYPE "VIDEO"
...
public:
    string GetFilesOnServer()
    {
        ...
        ServerDir = opendir(".//Storage//Server_VIDEO"); // Server directory
        if (ServerDir)
        {
    ...
    void SendSelectedFile(int MyNewSocket, string FileName)
    {
        ...
        string ServerPath = ".//Storage//Server_VIDEO//";
